...
@section('style')
{{-- <link rel="stylesheet" href="../resources/assets/assets/vendor/charts/c3charts/c3.css"> --}}
...
<body> 
                            ...
                            {{-- <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="float-right icon-circle-medium  icon-box-lg  bg-alert-light mt-1">
                                            <i class=" fa fa-exclamation-triangle fa-fw fa-sm text-alert"></i>
                                        </div>
                                    </div>
                                </div>
                            </div> --}}
    ...
    @section('script')
        {{-- <script src="../resources/assets/assets/vendor/charts/c3charts/c3.min.js"></script>
        <script src="../resources/assets/assets/vendor/charts/c3charts/d3-5.4.0.min.js"></script>
        <script src="../resources/assets/assets/vendor/charts/c3charts/C3chartjs.js"></script> --}}
